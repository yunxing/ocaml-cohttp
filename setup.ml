...
(* OASIS_START *)
(* DO NOT EDIT (digest: f2ff128e4c48a9b95dd34f519bfe9587) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ...
          ("cohttp_mirage_unix", OCamlbuildDocPlugin.doc_build "mirage");
     ...
     clean_doc =
       [
          ...
          ("cohttp_mirage_unix", OCamlbuildDocPlugin.doc_clean "mirage");
          ("cohttp_mirage_xen", OCamlbuildDocPlugin.doc_clean "mirage")
       ];
     distclean = [];
     distclean_test =
       [
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the Mirage library for Unix";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the Mirage library for Xen";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
               ...
               Library
                 ({
                      ...
                      bs_build =
                        [
                           ...
                           (OASISExpr.EOr
                              (OASISExpr.EFlag "lwt",
                                OASISExpr.EOr
                                  (OASISExpr.EFlag "mirage_unix",
                                    OASISExpr.EFlag "mirage_xen")),
                             true)
                        ];
                      bs_install =
                        [
                   ...
                   {
                      lib_modules = ["Cohttp_lwt_body"; "Cohttp_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "mirage_unix", true)
                        ];
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-tcpip-unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Cohttp_mirage_io"; "Cohttp_mirage"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
                      lib_findlib_name = Some "mirage-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "cohttp_mirage_xen";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "mirage_xen", true)
                        ];
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
                      lib_findlib_name = Some "mirage-xen";
                      lib_findlib_containers = []
                   });
               Library
                 ({
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "=e°Ëo]Á/¡rÎªø\138\031ï";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
