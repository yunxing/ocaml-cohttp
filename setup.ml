...
(* OASIS_START *)
(* DO NOT EDIT (digest: babc8a602e2b1045bfca872384c52507) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "protocol";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "cohttp_protocol";
                   ...
                   {
                      lib_modules =
                        ["Cohttp_lwt"; "Cohttp_lwt_net"; "Cohttp_lwt_body"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
                      lib_findlib_name = Some "lwt_core";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lwt", None);
                           InternalLibrary "cohttp_lwt_core";
                   ...
                   {
                      lib_modules = ["Cohttp_lwt_unix_io"; "Cohttp_lwt_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Cohttp_lwt_mirage_io"; "Cohttp_lwt_mirage"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "}]c\148Otòò\002Ò\132\132ö£\023\001";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
